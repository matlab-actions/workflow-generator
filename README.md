...
Use [GitHub&reg; Actions Workflow Generator for MATLAB](https://matlab-actions.github.io/workflow-generator/) to create a starter workflow for a repository that contains MATLAB&reg; code or Simulink&reg; models. You can use the generated workflow as a starting point for your own custom workflow.
